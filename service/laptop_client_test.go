...
import (
	...
	"github.com/adwait-godbole/learning-grpc/service"
...
func TestClientCreateLaptop(t *testing.T) {
	...
	// check that the laptop is really stored to the store on the server
...
func requireSameLaptop(t *testing.T, laptop1 *pb.Laptop, laptop2 *pb.Laptop) {
	// require.Equal(t, laptop1, laptop2) // does not work because the pb.Laptop struct has some internal fields used by gRPC
